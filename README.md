...
### 💰 **Система контроля расходов 2.0**

- **🚨 Умные алерты**: Уведомления при 75%, 90% и 100% бюджета
- **⚡ Автоматическое переключение**: На бесплатную модель при превышении лимита  
- **📊 Детальная аналитика**: Расходы по дням и месяцам
- **💎 Премиум по умолчанию**: Claude 3.5 Sonnet для максимального качества
...
- Хабр (AI, ML, DataScience разделы)
- Хакер (кибербезопасность и технологии)
- CNews AI
- 3DNews
- Tproger

**Итого: 15 качественных источников** (было 12)
...
|------------|----------------------|----------|
| `AI_MODEL` | `anthropic/claude-3.5-sonnet` | 🔥 **НОВОЕ**: Премиум модель для лучшего качества |
| `MAX_MONTHLY_COST` | `5.0` | Месячный лимит ($5) с автоматическими алертами |
| `ADMIN_TELEGRAM_ID` | - | **ОБЯЗАТЕЛЬНО**: Ваш Telegram ID для алертов |